...
class Motorbike extends Vehicle {
  ...
  // TODO: The properties should include vin, color, make, 
  // model, year, weight, top speed, and wheels
    // TODO: The types should be as follows: vin (string), color (string), make (string), 
    // model (string), year (number), weight (number), 
  ...
  wheelie(): void {
    ...
    console.log(`Motorbike ${this.make} ${this.model} is doing a wheelie WOOOOOOOOO!`);
  }
